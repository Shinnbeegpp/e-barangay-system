                ...
                {requests.map(r => (
                  <tr key={r.id}>
                    ...
                    <td>
                      ...
                      {r.soft_copy_url && <a href={r.soft_copy_url} download target="_blank" rel="noreferrer" className="btn btn-sm btn-outline">{r.soft_copy_url.match(/\.pdf$/i) ? '📥 Download PDF' : '🖼️ View'}</a>}
                    </td>
                  </tr>
                ))}
              </tbody>
