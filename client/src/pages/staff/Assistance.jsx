          ...
          <div className="modal" style={{ maxWidth: 700 }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ textAlign: 'center' }}>
              {viewFileUrl.includes('/raw/') || viewFileUrl.match(/\.pdf$/i)
                ? <iframe src={`https://docs.google.com/viewer?url=${encodeURIComponent(viewFileUrl)}&embedded=true`} style={{ width: '100%', height: 500, border: 'none', borderRadius: 8 }} title="Document" />
