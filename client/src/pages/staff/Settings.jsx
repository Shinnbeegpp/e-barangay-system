...
export default function StaffSettings() {
  ...
  return (
    <div>
      <div className="page-header"><div><h2>Account Settings</h2><p>Update your staff account credentials</p></div></div>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        ...
        <form onSubmit={handleEmailUpdate}>
          ...
          <div className="form-group">
            ...
            <input className="form-input" type="password" value={emailForm.current_password}
